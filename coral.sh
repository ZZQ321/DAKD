    ...
    do
    for algorithm in CORAL 
    do
    python -m domainbed.scripts.sweep ${command}  --data_dir /home/zzq/data --skip_confirmation --single_test_envs\
    --output_dir=./domainbed/output/${algorithm}/  --command_launcher local --algorithms ${algorithm} \
    --datasets PACS  --n_hparams 1 --n_trials 1 --hparams """{\"resnet18\":0}""" 
